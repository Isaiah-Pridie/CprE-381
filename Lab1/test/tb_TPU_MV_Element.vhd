...
begin
  ...
  begin
   ...
   ------------------------------------------------------------------
    ...
    -- Test case 3:
    -- Testing when s_iW input is 0
    s_iX   <= x"05";   -- 5 in hex
    s_iW   <= x"00";   -- 0 in hex
    s_iLdW <= '1';     -- Make sure s_iW is loaded
    s_iY   <= x"1E";   -- 30 in hexadecimal
    wait for gCLK_HPER*2;
    wait for gCLK_HPER*2;
    -- Expect: o_Y output signal to reflect s_iY (30)

    -- Test case 4:
    -- Testing when s_iX input is 0
    s_iX   <= x"00";   -- 0 in hex
    s_iW   <= x"05";   -- 5 in hex
    s_iLdW <= '1';     -- Make sure s_iW is loaded
    s_iY   <= x"23";   -- 35 in hexadecimal
    wait for gCLK_HPER*2;
    wait for gCLK_HPER*2;
    -- Expect: o_Y output signal to reflect s_iY (35)
    ...
    wait for gCLK_HPER*2;
    wait for gCLK_HPER*2;
    -- Expect: o_Y output to be only s_iX * s_iW (20)
